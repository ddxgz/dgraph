...
type Membership struct {
	...
	// Need both group_id and id for add or remove
	ClearRemoved bool `protobuf:"varint,5,opt,name=clearRemoved,proto3" json:"clearRemoved,omitempty"`
	Removed      bool `protobuf:"varint,6,opt,name=removed,proto3" json:"removed,omitempty"`
	// group_id is not required while banning a server, only id would do
...
func (m *Membership) GetClearRemoved() bool {
	if m != nil {
		return m.ClearRemoved
	}
	return false
}

func (m *Membership) GetRemoved() bool {
	if m != nil {
		return m.Removed
	}
	return false
...
func (m *Membership) GetBanned() bool {
	if m != nil {
		return m.Banned
	}
	return false
...
func (m *Membership) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClearRemoved", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorTask = []byte{
	...
	,
}
